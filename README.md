...
<img alt="源计划" src="./imageY.jpg" width="700" />
...
- P0 元理论：我们的基础理论假设
- P1 社会企业：**学记智能**，专注教育智能化，提供专业知识服务！
- P2 开放社区: **源计划**，基于区块链智能合约技术构建的DAO组织自治平台
- P3 工具平台：**学记助理**，智能文档、学记云、知识管理、GTD、知识可视化、智能模板
- P4 领域语言：**Magic**，DSL、交互、命令、编程
- P5 虚拟空间：元宇宙、数字孪生
- P6 贡献积分系统：基于区块链的经济系统、徽章、智点
- P7 开放知识图谱：领域知识图谱、百科知识库
- P8 大数据：数据可视化、深度学习
- P9 智能硬件：电子纸笔、穿戴、机器人终端、物联网
- PA 线下空间：🍮 Tea AI Coffee
...
入群交流，请添加微信：  
<img alt="个人微信二维码" src="./imageaaron.png" width="160" /> 
